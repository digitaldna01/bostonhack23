...
const Maps2TrainRoute = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.maps2TrainRoute}>
      <Image
        style={[styles.capturaDePantalla20231118, styles.capturaPosition]}
        contentFit="cover"
        source={require("../assets/captura-de-pantalla-20231118-a-las-1838-2.png")}
      />
      <View
      ...
      />
      <Image
        style={[styles.layer1Icon, styles.layer1IconLayout1]}
        contentFit="cover"
        source={require("../assets/layer-12.png")}
      />
      <Image
        style={[styles.layer1Icon1, styles.layer1IconLayout1]}
        contentFit="cover"
        source={require("../assets/layer-12.png")}
      />
      <Image
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/captura-de-pantalla-20231118-a-las-1838-21.png")}
      />
      <Image
      ...
      />
      <Image
        style={[styles.layer1Icon4, styles.layer1IconLayout]}
        contentFit="cover"
        source={require("../assets/layer-16.png")}
      />
    </View>
...
export default Maps2TrainRoute;
